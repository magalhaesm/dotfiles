return {
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- Associates each diagnostic type with its corresponding icon, defining Vim diagnostic signs.
      ...
      -- Additional configuration for the LSP (Language Server Protocol) UI.
      -- Here, the border of floating windows is set to 'rounded'.
